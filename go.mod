...
replace (
	// these replacements are pinned to 1e11e4a21080 which is the sha associated with the 1.19.3 tag on k/k
	// as you cannot pin them to v1.19.3 directly
	...
	k8s.io/controller-manager => k8s.io/kubernetes/staging/src/k8s.io/controller-manager v0.0.0-20201014123937-1e11e4a21080
	...
	k8s.io/sample-cli-plugin => k8s.io/kubernetes/staging/src/k8s.io/sample-cli-plugin v0.0.0-20201014123937-1e11e4a21080
	k8s.io/sample-controller => k8s.io/kubernetes/staging/src/k8s.io/sample-controller v0.0.0-20201014123937-1e11e4a21080
)
